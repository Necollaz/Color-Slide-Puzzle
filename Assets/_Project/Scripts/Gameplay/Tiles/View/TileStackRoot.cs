...
{
    [SerializeField] private TileStackView _tileStackView;
    [SerializeField] private float _dragLerpSpeed = 25.0f; 
    ...
    private void Awake()
    {
        ...
        _draggable = new TileStackDraggable(transform, _dragLerpSpeed);
    }
